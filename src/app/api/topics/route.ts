...
export async function GET() {
  ...
  const topics = (await readCollectionAsync<Topic>("topics")).sort(
...
export async function PUT(req: NextRequest) {
  ...
  const updated = await updateInCollectionAsync<Topic>("topics", body.id, {
    ...body,
...
export async function DELETE(req: NextRequest) {
  ...
  const deleted = await deleteFromCollectionAsync<Topic>("topics", id);
